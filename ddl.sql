...
CREATE TABLE IF NOT EXISTS  asset_insurance_type (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  bridge_drawdown_types (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
  updated_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  client_form_status (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
  updated_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  deal_aborted_reasons (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  title text NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
  updated_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  deal_document_risk (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  deleted_at timestamp without time zone DEFAULT NULL,
  created_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  drawdown_event_amount_type (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  deleted_at timestamp without time zone DEFAULT NULL,
  created_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  drawdown_event_status (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  deleted_at timestamp without time zone DEFAULT NULL,
  created_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  guarantor_corporates (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  guarantor_individuals (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  title varchar(255) DEFAULT NULL,
  first_name varchar(255) NOT NULL,
  middle_name varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  guarantor_type (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
  updated_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  interest_calculation_types (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS  interest_subtypes (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
  updated_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  introducer_type (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
  updated_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  loan_calculation_method (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
  updated_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  profile_approval_status (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
  updated_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  purpose_credit_types (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
  updated_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  quotes_status (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  deleted_at timestamp without time zone DEFAULT NULL,
  created_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  sharepoint_updates_timestamps (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  systems_deal_setting_groups (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name text NOT NULL,
...
CREATE TABLE IF NOT EXISTS  valuation_statuses (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  deleted_at timestamp without time zone DEFAULT NULL,
  created_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  variable_rate_settings (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS  variable_rate_sources (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
  updated_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  drawdown_event_type (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  fee_type_lending_type (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  systems_deal_setting (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name text NOT NULL,
  order_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  variable_rates (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  variable_rates_history (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  date date NOT NULL,
  variable_rate_source_id bigint NOT NULL,
  rate numeric(22,4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  variable_rates_history_copy1 (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  date date NOT NULL,
  variable_rate_source_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  lender_funder_interest_rate (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  asset_client_companies (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  asset_client_individuals (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  asset_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  asset_insurance_notes (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  broker_agent_deals (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  broker_agent_notes (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  broker_agent_id bigint NOT NULL,
  note_id bigint NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  client_company_clients (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  client_company_id bigint NOT NULL,
  client_individual_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  client_company_notes (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  client_company_id bigint NOT NULL,
  note_id bigint NOT NULL,
  deleted_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  client_form_attachments (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  client_form_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  client_group_clients (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  client_individual_credit_data (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  client_individual_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  client_individual_notes (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  client_individual_id bigint NOT NULL,
  note_id bigint NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  deal_document_categories (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  deal_document_categories_data (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  deal_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  deal_introducers (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  deal_notification_rules (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  deal_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  deal_notification_rules_recipients (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  deal_rate_floors (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS  deal_setting_groups (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name text NOT NULL,
  order_id bigint NOT NULL,
  deal_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  deal_task_group (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) NOT NULL,
  order_id bigint NOT NULL,
  deal_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  drawdown_fees (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  drawdown_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  drawdown_fields_approval (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  field_name varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS  email_code_authentication (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  user_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  exit_fee_tiers (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  deal_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS  lender_operational_team_admin (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  user_id bigint NOT NULL,
  lender_id bigint NOT NULL,
  created_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  loan_administrators (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  deal_id bigint NOT NULL,
  client_individual_id bigint DEFAULT NULL,
  client_company_id bigint DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  loan_custom_forms (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  name varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  margin_override (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  drawdown_id bigint NOT NULL,
  from date NOT NULL,
  to date NOT NULL,
...
CREATE TABLE IF NOT EXISTS  quotes_recipients (
  id bigint GENERATED BY DEFAULT AS IDENTITY,
  quote_id bigint NOT NULL,
  client_individual_id bigint DEFAULT NULL,
